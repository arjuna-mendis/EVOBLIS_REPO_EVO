...
# calibration = Calibration(evobot, head, petridish=petridish, syringe=syringe0)
...
calibration = Calibration(evobot, head, customPoints=([50, 150], [190, 150], [130, 475]), syringe=syringe4)
