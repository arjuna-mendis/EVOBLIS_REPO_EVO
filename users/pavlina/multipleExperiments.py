...
syringe16 = Syringe(evobot, SYRINGES['SYRINGE12']) #Experiment C
...
expC = ExperimentC(evobot, head, syringe12, dispensingModule,powerOutputs)
EM= MFCsEvolutionaryExperiment(3)
