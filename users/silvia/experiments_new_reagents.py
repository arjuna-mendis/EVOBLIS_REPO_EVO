...
distance_from_center = 10.0  # distance from the center of the petridish to pull decanol and salt
park_head_pos = (0, 0)
...
class NewReagentsExperiments:
    ...
    def salt_push(self, petridish, salt_vol):
        ...
        print "the salt was pushed in %s in salt coordinates" % ((x_p, y_p - (distance_from_center+10)),)
    ...
    def perform_experiment(self, petri, gen, individual_num, reagent_name, replica_num):
        ...
        # We start an exp!!!
        file_name_addition = "generation%d_ind_num%d_replica%d_reagent:%s" % (gen, individual_num, replica_num, reagent_name)
